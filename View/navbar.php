...
?>
<nav class="navbar navbar-expand-md navbar-light fondo">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
                ...
                <?php
                    ...
                    echo '<a href="view/mostrarcarrito.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart4 mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
